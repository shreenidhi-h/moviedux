		...
		<div className="App">
			<div className="container">
				...
				<Router>
					<nav>
						<ul className="flex justify-center items-center m-5">
							<li className="bg-cyan-700 hover:border-black font-semibold border-2 rounded-lg p-3 m-6 text-center">
								<Link to="/">Home</Link>
							</li>
							<li className="bg-cyan-700 hover:border-black font-semibold m-6 border-2 rounded-lg p-3 text-center">
