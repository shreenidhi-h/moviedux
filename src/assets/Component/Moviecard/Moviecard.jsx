export default function Moviecard({ movie, isWatchlisted, toggleWatchlist }) {
	...
	return (
		<div
			key={movie.id}
			className="rounded-lg transition duration-150 hover:ease-in-out overflow-hidden flex flex-col bg-cyan-900 justify-center items-center shadow-lg shadow-black hover:scale-110"
		>
			<img
